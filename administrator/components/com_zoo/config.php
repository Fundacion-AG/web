...
// set defines
define('ZOO_COPYRIGHT', '<div class="copyright"><a target="_blank" href="http://zoo.yootheme.com">ZOO</a> Configurado por: <a target="_blank" href="http://www.uneg.edu.ve">UNEG (Administración de la Información 2014-I)</a>.<br> Todos los Derechos Reservados.</div>');
