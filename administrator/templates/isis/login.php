...
<body class="site <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " itemid-" . $itemid . " ";?>">
	...
	<div class="container">
		<div id="content">
			...
			<div id="element-box" class="login well">
                ...
                <img src="../templates/fag/images/logo/logo.png" alt="Fundación Amigos del Gesto!" />
				<hr />
	...
	<div class="navbar navbar-fixed-bottom hidden-phone">
		...
		<a class="login-fag" href="http://www.amigosdelgesto.com.ve" target="_blank" class="hasTooltip" title="<?php echo JHtml::tooltipText('TPL_ISIS_ISFREESOFTWARE');?>">FAG!&#174;</a>
