<?php
/**
 * @version   $Id: index.php 20563 2014-04-22 13:02:15Z arifin $
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	<div id="rt-page-surround" class="<?php if ($gantry->get('pagesurround-parallax')) : ?>rt-parallax<?php endif; ?>"<?php if ($gantry->get('pagesurround-parallax')):?> data-parallax-delta="<?php echo $gantry->get('pagesurround-speed', 0.3);?>"<?php endif; ?>>
		<div class="rt-container">
			<?php /** Begin Header Surround **/ if ($gantry->countModules('header') or $gantry->countModules('drawer') or $gantry->countModules('top') or $gantry->countModules('utility') or $gantry->countModules('showcase')) : ?>
			...
			<?php /** Popup Login and Popup Module **/ 
             ...
             echo $gantry->displayModules('creditos','creditos','popup');
			 echo $gantry->displayModules('popup','popup','popup');
			/** End Popup Login and Popup Module **/ ?>
		</div>
	</div>
</body>
</html>
